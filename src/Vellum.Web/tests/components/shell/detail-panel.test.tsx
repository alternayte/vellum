...
describe('DetailPanel', () => {
  it('renders nothing visible when no selection', () => {
    render(<DetailPanel elements={ELEMENTS} relationships={RELATIONSHIPS} />)
  ...
  it('calls onUpdateElement on name input blur', () => {
    ...
    render(<DetailPanel elements={ELEMENTS} relationships={RELATIONSHIPS} onUpdateElement={onUpdate} />)
